...
function createData(NAME, UHS2, UHS4, UHS6) {
    return { NAME, UHS2, UHS4, UHS6};
}
const row1=[
    createData('Non-Sharable Amount (NSA) Per Member	', '$1,500', '$5,000', '$6,000'/*, '$5,000','$5,000','$6,000'*/),
    createData('Non-Sharable Amount (NSA) for 2 Persons	', '$3,000', '$10,000','$12,000'/*,'$10,000','$10,000','$12,000'*/),
    createData('Non-Sharable Amount (NSA) for 3 or more	', '$4,500','$15,000','$18,000'/*,'$15,000','$15,000','$18,000'*/),
];
const row2=[
...
const row3=[
    ...
    createData('Sharing Program Maximums per Member  ', 'Nine (9) visit maximum for any combination of Primary Care, Specialist and Urgent Care. Nine (9) visit maximum for pre-natal care of 30 days.'),
...
const row4=[
    ...
    createData('Annual Physical / Wellness Exam and Preventive Services  	', 'Members are eligible for one (1) Routine Physical/Wellness Exam per year after 30 days of continuous membership. Limit of Sharing Amount for Routine Physical, Wellness Exam and Preventive Care services combined is $500 per member per year.'),
    ...
    createData('Specialty Care - Office Visit  	  	', '$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee'),
...
const rows = [
    {id:1,name:'Physician and Ancillary services', ans:'In Network Only – PHCS / MultiPlan Nationwide Provider Network'},
    {id:2,name:'Hospital  ',ans: 'Any Hospital, Anywhere in the USA'},

    {id:3,name:'Non-Sharable Amount (NSA) Per Member', ans:['$1,500','$5,000', '$6,000'/*, '$5,000','$5,000','$6,000'*/]},
    ...
    {id:9,name:'Sharing Program Maximums per Member  ', ans:'Nine (9) visit maximum for any combination of Primary Care, Specialist and Urgent Care. Nine (9) visit maximum for pre-natal care of 30 days.'},
    ...
    {id:12,name:'Annual Physical / Wellness Exam and Preventive Services  	', ans:'Members are eligible for one (1) Routine Physical/Wellness Exam per year after 30 days of continuous membership. Limit of Sharing Amount for Routine Physical, Wellness Exam and Preventive Care services combined is $500 per member per year.'},
    ...
    {id:14,name:'Specialty Care - Office Visit', ans:['$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee','$70 Consult Fee']},
...
class PbGrid extends React.Component {
...
Sharing Guidelines" placement='right'>
                        ...
                        <StyledTableRow  style={{border:'2px solid #ffffff'}} key={11}>
                            ...
                            <StyledTableCell align="center" style={customStyle.cellChild}>$350,000</StyledTableCell>
                        ...
                        <StyledTableRow style={{border: '2px solid #ffffff'}} key={12}>
                            ...
                            <StyledTableCell align="center" colSpan={6} style={{fontFamily:'Palatino Linotype, Book Antiqua, Palatino, serif',fontColor:'#420045',backgroundColor:'#fae6be'}}>Nine (9) visit maximum for any combination of Primary Care, Specialist and Urgent Care. Nine (9) visit maximum for pre-natal care of 30 days .</StyledTableCell>
                        ...
                        <StyledTableRow style={{border : '2px solid #ffffff'}} key={16}>
                            ...
                            <StyledTableCell align="center" colSpan={6} style={customStyle.cellChild}>Members are eligible for one (1) Routine Physical/Wellness Exam per year after 30 days of continuous membership.
