...
class sampleTextField extends Component{
    ...
    onChange=(event)=>{
        ...
        if(txtVal !== ""){
            switch (this.props.fieldType) {
                ...
                case 'accountName' : {
                    if(txtVal.match(/^[a-zA-Z -_]{1,120}$/)) {
                        this.setState({ errorText: '', isValid : false,value:txtVal});
                        this.props.setChild(txtVal,true,this.props.parentDetails);
                        break;
                    } else {
    ...
    render() {
        ...
        return (
            <CustomTextField
                       error={(this.props.value === '' && this.state.isValid) || this.props.isValidFullName === false}
                       ...
                       required={this.props.reqFlag}
                        InputLabelProps={{style: {color:((this.props.value === ''&& this.state.isValid) || this.props.isValidFullName === false)?'#FA1515':''}}}
                       inputProps={{
