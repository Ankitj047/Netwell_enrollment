...
export default  class ChatButton extends Component {
    ...
    componentDidMount(){
        ...
        if(cookiesData && cookiesData.isAgent){
            URL=configuration.agentURL + '/setupfamily/getEnrollFlagBySubId/' + cookiesData.subID
        }else{
            URL=configuration.agentURL + '/setupfamily/getEnrollFlag/' + sessionStorage.getItem('userMail')
