...
class AutoMechanicPayment extends React.Component {
  constructor(props) {
    super(props);
    let mon = [
      "Jan",
      ...
      .then((response) => {
        this.setState({
          paymentData: response.response,
            ...
            let totalAmt = this.state.paymentData[this.state.paymentData.length - 2].amount
...
this.props.onClick()
        ...
        //   else { // uncomment when want to show popup message (your account will be charged)
            // axios
              // .post(
              ...
              //   console.log(res);
                ...
                //               );
                              ...
                              let now = moment();
// uncomment when want to show popup message (your account will be charged)  
      ...
      <div>
        ...
        <div>
          ...
          <Grid container spacing={1} style={{ marginTop: "1%" }}>
            <Grid item xs={12} sm={8}>
            <Checkbox
                checked={this.state.checkboxSelect}
                inputProps={{
                  "aria-label": "secondary checkbox",
                }}
                style={{ color: "#533278", marginLeft: -12 }}
                onClick={this.showCheckbox}
              />
            <b>I agree that the amount {this.state.totalAmount} will be withheld from my paycheck by my employer.</b>
...
export default connect(mapStateToProps)(AutoMechanicPayment);
